...
function User(props) {
    ...
    const setPrefEmail = (newVal) => {
        prefEmail.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const setPhoneNumber = (newVal) => {
        phoneNumber.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const setPreferredContactMethod = (newVal) => {
        preferredContactMethod.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const setGender = (newVal) => {
        gender.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const setEthnicity = (newVal) => {
        ethnicity.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const pp = useRef('')
    const setPp = (newVal) => {
        pp.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const bio = useRef('')
    const setBio = (newVal) => {
        bio.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const fb = useRef('')
    const setFb = (newVal) => {
        fb.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const ig = useRef('')
    const setIg = (newVal) => {
        ig.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
    ...
    const li = useRef('')
    const setLi = (newVal) => {
        li.current = newVal ? sanitizeHtml(newVal, {
            allowedTags: [],
            allowedAttributes: []
        }) : "";
